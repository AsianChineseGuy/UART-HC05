...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/UART-HC05.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/UART-HC05.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
